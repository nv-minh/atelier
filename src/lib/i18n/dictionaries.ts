...
export const dictionaries: Record<Lang, Record<string, any>> = {
  vi: {
    ...
    practice: {
      ...
      exit: "Thoát phiên học",
      exitConfirm: "Đã làm {n} thẻ — thoát phiên học?",
    ...
    auth: {
      ...
      reasons: {
        ...
        grammar: "Đăng nhập để làm bài test và lưu tiến độ ngữ pháp.",
  ...
  en: {
    ...
    practice: {
      ...
      exit: "Exit session",
      exitConfirm: "Answered {n} cards — leave this session?",
    ...
    auth: {
      ...
      reasons: {
        ...
        grammar: "Sign in to take tests and save your grammar progress.",
